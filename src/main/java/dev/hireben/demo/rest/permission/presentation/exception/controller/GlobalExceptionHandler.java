package dev.hireben.demo.rest.permission.presentation.exception.controller;
...
import dev.hireben.demo.rest.permission.presentation.exception.dto.FieldValidationErrorMap;
import dev.hireben.demo.rest.permission.presentation.exception.model.SeverityLevel;
import dev.hireben.demo.rest.permission.presentation.model.RequestAttributeKey;
...
public class GlobalExceptionHandler {
  ...
  // private static final Map<Class<? extends Throwable>, HttpStatus>
  // EXCEPTION_STATUS_MAP = Map.of();

  // private static final Map<Class<? extends Throwable>, String>
  // EXCEPTION_CODE_MAP = Map.of();
  ...
  // HttpStatus status = EXCEPTION_STATUS_MAP.getOrDefault(errorClass,
